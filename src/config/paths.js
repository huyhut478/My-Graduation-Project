...
const REVIEWS_PATH = path.join(PUBLIC_PATH, 'img', 'reviews');

// Ensure required directories exist
for (const dir of [DATA_PATH, ICONS_PATH, AVATARS_PATH, REVIEWS_PATH]) {
  if (!fs.existsSync(dir)) {
    fs.mkdirSync(dir, { recursive: true });
  }
}

export { ROOT_DIR, VIEWS_PATH, PUBLIC_PATH, DATA_PATH, ICONS_PATH, AVATARS_PATH, REVIEWS_PATH };
